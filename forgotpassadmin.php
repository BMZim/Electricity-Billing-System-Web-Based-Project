...
<body>
    ...
    <h2>Recover Your Password</h2>
        ...
        <input type="number" id="jobid" name="jobid" placeholder="Enter your jobid" required><br><br>
...
if(isset($_POST['submit'])){
    ...
    $sql = "select * from adminlogin where jobid='$jobid'";
    ...
    if(mysqli_num_rows($result)>0){
       ...
       if($question === $rows['Security_Question'] && $answer=== $rows['answer']){
        $sql1 = "update adminlogin set PASSWORD='$pass' where jobid='$jobid'";
